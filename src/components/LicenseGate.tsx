...
export function LicenseGate({ children }: Props) {
  ...
  if (info.status === "blocked") {
    const isExpired = info.daysLeft < -7; // past grace period
    const noKey = info.daysLeft === -999;  // no key at all
            ...
            <div className="px-6 py-5 text-center"
              ...
              {isExpired ? (
                <>
                  ...
                  <p className="text-sm text-red-600 mt-1">Your grace period has ended. Please renew your license to continue.</p>
                </>
              ) : (
                <>
              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    placeholder="MNGM-XXXX-XXXX-XXXX-XXXX"
                    className="w-full px-4 py-3 pr-10 rounded-xl border-2 border-slate-200 focus:outline-none focus:border-indigo-400 font-mono text-sm tracking-wider uppercase"
                  />
